...
## [UNRELEASED](https://github.com/quartiq/miniconf/compare/miniconf-v0.21.1...HEAD) - DATE
...
* Report conflicting JSON Schema type names as errors instead of panicking.
